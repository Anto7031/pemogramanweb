		...
		$password = "";
		 ...
		 if (isset($_POST['submit'])) {
			...
			if ($ussername && $password) {
				$sql1 = mysqli_query($koneksi, "select * from masuk where ussername ='$ussername'and password = '$password'");
				if ($sql1->num_rows>0) {
					$this->load->view('utama');
					exit();
				}else {
					$error = "Maaf Password atau Ussername Anda salah";
				}
			}else{
				$error = 'Masukkan Ussername dan Password Anda!';
			}
		}
	?>
</head>
