        ...
        <div class="content-area">
            ...
            <div class="content-area-inner">
                    ...
                    <div class="container-mid">
                        ...
                        <div class="animation-container animation-fade-left" data-animation-delay="300">
                           ...
                           <p class="subline"><?=$data->deskripsi?></p>
                            <!-- <p class="subline">Saya adalah salah satu mahasiswa di sebuah perguruan tinggi swasta politeknik kampar semester 4. Dengan di bekali ilmu yang luar biasa yang di dapatkan dari tenaga pengajar yang sudah profesional di dalam bidang nya masing-masing sehingga melahirkan ligenerasi anak bangsa yang siap menjadi pemimpin di masa yang akan mendatang nantinya.</p> -->
                ...
                <section id="about">
                    ...
                    <p class="scroll-animated-from-right"><?php foreach ($data2 as $key) : ?>
                        <ul>
                    ...
                    <div class="showcase">
                        ...
                        <div class="item scroll-animated-from-right">
                            ...
                            <div id="item-4-lightbox" class="work-lightbox">
                                ...
                                <p>Saya adalah salah satu mahasiswa di sebuah perguruan tinggi swasta politeknik kampar semester 4. Dengan di bekali ilmu yang luar biasa yang di dapatkan dari tenaga pengajar yang sudah profesional di dalam bidang nya masing-masing sehingga melahirkan ligenerasi anak bangsa yang siap menjadi pemimpin di masa yang akan mendatang nantinya.</p>
                ...
                <section id="contact">
                    ...
                    <ul class="contact-list">
                        ...
                        <li class="scroll-animated-from-right"><i class="fa fa-mobile" aria-hidden="true"></i>082249789520</li>
                        <li class="scroll-animated-from-right"><i class="fa fa-envelope-o" aria-hidden="true"></i>hendririyanto2000@gmail.com</li>
